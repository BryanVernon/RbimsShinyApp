...
# Background
## Microorganisms are a very diverse group where many organisms share similar metabolic pathways and others are very unique. The purpose of this application is to help visualize these relationships between microorganism, their metabolic pathways, and the genes that code for these pathways. 

# About RbiMs
## An interactive open source software tool for using R to reconstruct bin metabolisms (Rbims). 

# RbiMs tutorial
## Step 1: Upload data into Rbims
### Run kegg on your protein 
